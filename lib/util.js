...
const showNextSteps = config => {
  if (process.platform === 'darwin') {
    ...
    log(
      chalk`{green.bold SSH key and config generated successfully 🎉  and public key has been printed to the console(Check above). Please copy it to your Clipboard. \n\n}`
    );
    log(
      chalk`{blue.bold To start using this ssh key, you need to follow below few steps :\n1. Login into your ${
        config.hostingProvider
